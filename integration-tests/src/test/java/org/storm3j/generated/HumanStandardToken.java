...
public class HumanStandardToken extends Contract {
    ...
    @Deprecated
    protected HumanStandardToken(String contractAddress, Storm3j storm3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, storm3j, credentials, gasPrice, gasLimit);
    }

    protected HumanStandardToken(String contractAddress, Storm3j storm3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, storm3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected HumanStandardToken(String contractAddress, Storm3j storm3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, storm3j, transactionManager, gasPrice, gasLimit);
    }

    protected HumanStandardToken(String contractAddress, Storm3j storm3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteCall<TransactionReceipt> approveAndCall(String _spender, BigInteger _value, byte[] _extraData) {
        final Function function = new Function(
                ...
                Arrays.<Type>asList(new org.storm3j.abi.datatypes.Address(_spender),
                new org.storm3j.abi.datatypes.generated.Uint256(_value),
                new org.storm3j.abi.datatypes.DynamicBytes(_extraData)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public static RemoteCall<HumanStandardToken> deploy(Storm3j storm3j, Credentials credentials, ContractGasProvider contractGasProvider, BigInteger _initialAmount, String _tokenName, BigInteger _decimalUnits, String _tokenSymbol) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.storm3j.abi.datatypes.generated.Uint256(_initialAmount),
                new org.storm3j.abi.datatypes.Utf8String(_tokenName),
                new org.storm3j.abi.datatypes.generated.Uint8(_decimalUnits),
                new org.storm3j.abi.datatypes.Utf8String(_tokenSymbol)));
        return deployRemoteCall(HumanStandardToken.class, storm3j, credentials, contractGasProvider, BINARY, encodedConstructor);
    }

    public static RemoteCall<HumanStandardToken> deploy(Storm3j storm3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider, BigInteger _initialAmount, String _tokenName, BigInteger _decimalUnits, String _tokenSymbol) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.storm3j.abi.datatypes.generated.Uint256(_initialAmount),
                new org.storm3j.abi.datatypes.Utf8String(_tokenName),
                new org.storm3j.abi.datatypes.generated.Uint8(_decimalUnits),
                new org.storm3j.abi.datatypes.Utf8String(_tokenSymbol)));
        return deployRemoteCall(HumanStandardToken.class, storm3j, transactionManager, contractGasProvider, BINARY, encodedConstructor);
    }

    @Deprecated
    public static RemoteCall<HumanStandardToken> deploy(Storm3j storm3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, BigInteger _initialAmount, String _tokenName, BigInteger _decimalUnits, String _tokenSymbol) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.storm3j.abi.datatypes.generated.Uint256(_initialAmount),
                new org.storm3j.abi.datatypes.Utf8String(_tokenName),
                new org.storm3j.abi.datatypes.generated.Uint8(_decimalUnits),
                new org.storm3j.abi.datatypes.Utf8String(_tokenSymbol)));
        return deployRemoteCall(HumanStandardToken.class, storm3j, credentials, gasPrice, gasLimit, BINARY, encodedConstructor);
    }

    @Deprecated
    public static RemoteCall<HumanStandardToken> deploy(Storm3j storm3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, BigInteger _initialAmount, String _tokenName, BigInteger _decimalUnits, String _tokenSymbol) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.storm3j.abi.datatypes.generated.Uint256(_initialAmount),
                new org.storm3j.abi.datatypes.Utf8String(_tokenName),
                new org.storm3j.abi.datatypes.generated.Uint8(_decimalUnits),
                new org.storm3j.abi.datatypes.Utf8String(_tokenSymbol)));
        return deployRemoteCall(HumanStandardToken.class, storm3j, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor);
    }
    ...
    @Deprecated
    public static HumanStandardToken load(String contractAddress, Storm3j storm3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new HumanStandardToken(contractAddress, storm3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static HumanStandardToken load(String contractAddress, Storm3j storm3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new HumanStandardToken(contractAddress, storm3j, transactionManager, gasPrice, gasLimit);
    }

    public static HumanStandardToken load(String contractAddress, Storm3j storm3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new HumanStandardToken(contractAddress, storm3j, credentials, contractGasProvider);
    }

    public static HumanStandardToken load(String contractAddress, Storm3j storm3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new HumanStandardToken(contractAddress, storm3j, transactionManager, contractGasProvider);
    }
