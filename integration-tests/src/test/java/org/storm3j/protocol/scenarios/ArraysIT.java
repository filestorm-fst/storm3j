...
import org.storm3j.generated.Arrays;
...
/** Simple integration test to demonstrate arrays usage in storm3j. */
public class ArraysIT extends Scenario {
    ...
    public void setUp() throws Exception {
        super.setUp();
        this.contract = Arrays.deploy(storm3j, ALICE, new DefaultGasProvider()).send();
    }
