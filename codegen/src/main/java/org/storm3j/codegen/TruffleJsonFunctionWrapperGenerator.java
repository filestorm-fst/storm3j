...
public class TruffleJsonFunctionWrapperGenerator extends FunctionWrapperGenerator {
    ...
    public static class Contract {
         ...
         *
         * @param network the contract's address on this Fst network
        ...
        /*
         * c.f., org.storm3j.tx.ChainId
         *
         * This should be updated with https://github.com/storm3j/storm3j/issues/234
         */
        enum Network {
            olympic(0),
