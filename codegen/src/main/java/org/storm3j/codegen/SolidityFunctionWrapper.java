...
import org.storm3j.utils.Collection;
import org.storm3j.utils.Strings;
import org.storm3j.utils.Version;
import org.storm3j.codegen.SolidityFunctionWrapperGenerator;
...
public class SolidityFunctionWrapper extends Generator {
    ...
    private static final String storm3j = "storm3j";
    ...
    private static final String CODEGEN_WARNING =
            "<p>Auto generated code.\n"
                    ...
                    + "<p>Please use the "
                    + "<a href=\"https://docs.storm3j.io/command_line.html\">storm3j command line tools</a>,\n"
                    + "or the "
                    + SolidityFunctionWrapperGenerator.class.getName()
                    + " in the \n"
                    + "<a href=\"https://github.com/storm3j/storm3j/tree/master/codegen\">"
    ...
    private void addAddressesSupport(TypeSpec.Builder classBuilder, Map<String, String> addresses) {
        if (addresses != null) {
            ...
            // See org.storm3j.tx.Contract#getStaticDeployedAddress(String)
    ...
    private TypeSpec.Builder createClassBuilder(
        ...
        String javadoc = CODEGEN_WARNING + getstorm3jVersion();
    ...
    private String getstorm3jVersion() {
        String version;

        try {
            // This only works if run as part of the storm3j command line tools which contains
            // a version.properties file
            version = Version.getVersion();
        } catch (IOException | NullPointerException e) {
            version = Version.DEFAULT;
        }
        return "\n<p>Generated with storm3j version " + version + ".\n";
    }
    ...
    private static MethodSpec buildConstructor(
        ...
        MethodSpec.Builder toReturn =
                MethodSpec.constructorBuilder()
                        ...
                        .addParameter(Storm3j.class, storm3j)
    ...
    private void buildConstantFunction(
        ...
        if (outputParameterTypes.isEmpty()) {
            ...
            ParameterizedTypeName parameterizedTupleType =
                    ParameterizedTypeName.get(
                            ClassName.get(
                                    "org.storm3j.tuples.generated", "Tuple" + returnTypes.size()),
    ...
    TypeSpec buildEventResponseObject(
            String className,
            List<org.storm3j.codegen.SolidityFunctionWrapper.NamedTypeName> indexedParameters,
            List<org.storm3j.codegen.SolidityFunctionWrapper.NamedTypeName> nonIndexedParameters) {
        ...
        for (org.storm3j.codegen.SolidityFunctionWrapper.NamedTypeName namedType :
                indexedParameters) {
    ...
    MethodSpec buildEventFlowableFunction(
        ...
        MethodSpec.Builder flowableMethodBuilder =
                MethodSpec.methodBuilder(generatedFunctionName)
                        .addModifiers(Modifier.PUBLIC)
                        .addParameter(FstFilter.class, FILTER)
        ...
        flowableMethodBuilder.addStatement(
                "return storm3j.ethLogFlowable(filter).map($L)", converter);
    ...
    private static Class<?> getStaticArrayTypeReferenceClass(String type) {
        try {
            return Class.forName("org.storm3j.abi.datatypes.generated.StaticArray" + type);
