...
import static org.storm3j.codegen.FunctionWrapperGenerator.JAVA_TYPES_ARG;
import static org.storm3j.codegen.FunctionWrapperGenerator.PRIMITIVE_TYPES_ARG;
import static org.storm3j.codegen.FunctionWrapperGenerator.SOLIDITY_TYPES_ARG;
import static org.storm3j.codegen.SolidityFunctionWrapperGenerator.COMMAND_GENERATE;
import static org.storm3j.codegen.SolidityFunctionWrapperGenerator.COMMAND_SOLIDITY;
import static org.storm3j.codegen.SolidityFunctionWrapperGenerator.getFileNameNoExtension;
...
public class SolidityFunctionWrapperGeneratorTest extends TempFileProvider {
    ...
    private void testCodeGeneration(
        ...
        if (types.equals(JAVA_TYPES_ARG)) {
            packageName = "org.storm3j.unittests.java";
        } else if (types.equals(SOLIDITY_TYPES_ARG)) {
            packageName = "org.storm3j.unittests.solidity";
        }
