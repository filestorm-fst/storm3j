...
public class RequestTest extends RequestTester {
    private Geth storm3j;

    @Override
    protected void initWeb3Client(HttpService httpService) {
        storm3j = Geth.build(httpService);
    }
    ...
    public void testPersonalImportRawKey() throws Exception {
        ...
        storm3j.personalImportRawKey(rawKey, password).send();
    ...
    public void testPersonalLockAccount() throws Exception {
        ...
        storm3j.personalLockAccount(accountId).send();
    ...
    public void testPersonalSign() throws Exception {
        ...
        storm3j.personalSign("0xdeadbeaf", "0x9b2055d370f73ec7d8a03e965129118dc8f5bf83", "hunter2")
                .send();
