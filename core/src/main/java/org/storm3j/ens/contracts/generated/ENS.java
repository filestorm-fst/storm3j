...
public class ENS extends Contract {
    ...
    @Deprecated
    protected ENS(String contractAddress, Storm3j storm3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, storm3j, credentials, gasPrice, gasLimit);
    }

    protected ENS(String contractAddress, Storm3j storm3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, storm3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected ENS(String contractAddress, Storm3j storm3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, storm3j, transactionManager, gasPrice, gasLimit);
    }

    protected ENS(String contractAddress, Storm3j storm3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteCall<TransactionReceipt> setSubnodeOwner(byte[] node, byte[] label, String owner) {
        final Function function = new Function(
                ...
                Arrays.<Type>asList(new org.storm3j.abi.datatypes.generated.Bytes32(node),
                new org.storm3j.abi.datatypes.generated.Bytes32(label),
                new org.storm3j.abi.datatypes.Address(owner)),
    ...
    public RemoteCall<TransactionReceipt> setTTL(byte[] node, BigInteger ttl) {
        final Function function = new Function(
                FUNC_SETTTL, 
                Arrays.<Type>asList(new org.storm3j.abi.datatypes.generated.Bytes32(node),
                new org.storm3j.abi.datatypes.generated.Uint64(ttl)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setResolver(byte[] node, String resolver) {
        final Function function = new Function(
                FUNC_SETRESOLVER, 
                Arrays.<Type>asList(new org.storm3j.abi.datatypes.generated.Bytes32(node),
                new org.storm3j.abi.datatypes.Address(resolver)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public static RemoteCall<ENS> deploy(Storm3j storm3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(ENS.class, storm3j, credentials, contractGasProvider, BINARY, "");
    }

    public static RemoteCall<ENS> deploy(Storm3j storm3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(ENS.class, storm3j, transactionManager, contractGasProvider, BINARY, "");
    }

    @Deprecated
    public static RemoteCall<ENS> deploy(Storm3j storm3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(ENS.class, storm3j, credentials, gasPrice, gasLimit, BINARY, "");
    }

    @Deprecated
    public static RemoteCall<ENS> deploy(Storm3j storm3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(ENS.class, storm3j, transactionManager, gasPrice, gasLimit, BINARY, "");
    }
    ...
    public Flowable<NewOwnerEventResponse> newOwnerEventFlowable(FstFilter filter) {
        return storm3j.fstLogFlowable(filter).map(new io.reactivex.functions.Function<Log, NewOwnerEventResponse>() {
            @Override
    ...
    public Flowable<NewResolverEventResponse> newResolverEventFlowable(FstFilter filter) {
        return storm3j.fstLogFlowable(filter).map(new io.reactivex.functions.Function<Log, NewResolverEventResponse>() {
            @Override
    ...
    public Flowable<NewTTLEventResponse> newTTLEventFlowable(FstFilter filter) {
        return storm3j.fstLogFlowable(filter).map(new io.reactivex.functions.Function<Log, NewTTLEventResponse>() {
            @Override
    ...
    @Deprecated
    public static ENS load(String contractAddress, Storm3j storm3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new ENS(contractAddress, storm3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static ENS load(String contractAddress, Storm3j storm3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new ENS(contractAddress, storm3j, transactionManager, gasPrice, gasLimit);
    }

    public static ENS load(String contractAddress, Storm3j storm3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new ENS(contractAddress, storm3j, credentials, contractGasProvider);
    }

    public static ENS load(String contractAddress, Storm3j storm3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new ENS(contractAddress, storm3j, transactionManager, contractGasProvider);
    }
