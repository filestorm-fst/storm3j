...
import static org.storm3j.crypto.Keys.ADDRESS_LENGTH_IN_HEX;
import static org.storm3j.crypto.Keys.PRIVATE_KEY_LENGTH_IN_HEX;
...
public class WalletUtils {
    ...
    /**
     * Generates a BIP-39 compatible Fst wallet. The private key for the wallet can be
     ...
     * @return A BIP-39 compatible Fst wallet
    ...
    /**
     * Generates a BIP-39 compatible Fst wallet using a mnemonic passed as argument.
     *
     * @param password Will be used for both wallet encryption and passphrase for BIP-39 seed
