 ...
 */
public class FstSyncing extends Response<FstSyncing.Result> {

    @Override
    @JsonDeserialize(using = FstSyncing.ResponseDeserialiser.class)
    public void setResult(FstSyncing.Result result) {
