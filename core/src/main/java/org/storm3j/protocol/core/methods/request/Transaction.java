 ...
 */
package org.storm3j.protocol.core.methods.request;
...
public class Transaction {
    ...
    public static Transaction createFstTransaction(
            String from,
            BigInteger nonce,
            BigInteger gasPrice,
            BigInteger gasLimit,
    ...
    public static Transaction createFstCallTransaction(String from, String to, String data) {
