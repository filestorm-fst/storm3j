 ...
 */
package org.storm3j.protocol.core.methods.response;
 ...
 * details on additional Parity fields present in FstBlock.
 */
public class FstBlock extends Response<FstBlock.Block> {

    @Override
    @JsonDeserialize(using = FstBlock.ResponseDeserialiser.class)
