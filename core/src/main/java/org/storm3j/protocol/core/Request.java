...
public class Request<S, T extends Response> {
    ...
    public Request(String method, List<S> params, Storm3jService storm3jService, Class<T> type) {
        this.method = method;
        this.params = params;
    ...
    public T send() throws IOException {
        return storm3jService.send(this, responseType);
    }

    public CompletableFuture<T> sendAsync() {
        return storm3jService.sendAsync(this, responseType);
    }
