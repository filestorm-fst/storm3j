...
public interface Storm3jRx {
     ...
     *     on the blockchain
     */
    Flowable<String> fstBlockHashFlowable();
     ...
     */
    Flowable<String> fstPendingTransactionHashFlowable();
     ...
     *     blockchain
     */
    Flowable<FstBlock> blockFlowable(boolean fullTransactionObjects);
     ...
     */
    Flowable<FstBlock> replayPastBlocksFlowable(
     ...
     *     in the {@link FstBlock} responses
     ...
     */
    Flowable<FstBlock> replayPastAndFutureBlocksFlowable(
            DefaultBlockParameter startBlock, boolean fullTransactionObjects);
