...
import org.storm3j.protocol.core.methods.response.FstGasPrice;
...
public abstract class ManagedTransaction {
    ...
    protected ManagedTransaction(Storm3j storm3j, TransactionManager transactionManager) {
        this(new EnsResolver(storm3j), storm3j, transactionManager);
    }

    protected ManagedTransaction(
            EnsResolver ensResolver, Storm3j storm3j, TransactionManager transactionManager) {
    ...
    public BigInteger requestCurrentGasPrice() throws IOException {
        ...
        return fstGasPrice.getGasPrice();
    }
