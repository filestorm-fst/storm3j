...
import org.storm3j.protocol.core.methods.response.FstGetCode;
...
import org.storm3j.tx.exceptions.ContractCallException;
...
public abstract class Contract extends ManagedTransaction {
    ...
    /**
     * @deprecated ...
     * @see org.storm3j.tx.gas.DefaultGasProvider
     */
    ...
    protected Contract(
        ...
        super(ensResolver, storm3j, transactionManager);
    ...
    protected Contract(
        ...
        this(
                ...
                contractAddress,
                storm3j,
                new RawTransactionManager(storm3j, credentials),
                gasProvider);
    }
    ...
    protected Contract(
            ...
            BigInteger gasPrice,
            BigInteger gasLimit) {
        this("", contractAddress, storm3j, transactionManager, gasPrice, gasLimit);
    }
     ...
     * @throws IOException if unable to connect to storm3j node
     */
        ...
        if (contractAddress.equals("")) {
            throw new UnsupportedOperationException(
                    "Contract binary not present, you will need to regenerate your smart "
                            + "contract wrapper with storm3j v2.2.0+");
        }

        FstGetCode fstGetCode =
                storm3j.fstGetCode(contractAddress, DefaultBlockParameterName.LATEST).send();
        if (fstGetCode.hasError()) {
            return false;
        }

        String code = Numeric.cleanHexPrefix(fstGetCode.getCode());
    ...
    protected static <T extends Contract> T deploy(
        ...
        try {
            ...
            T contract = constructor.newInstance(null, storm3j, credentials, contractGasProvider);
    ...
    protected static <T extends Contract> T deploy(
        ...
        try {
            ...
            // we want to use null here to ensure that "to" parameter on message is not populated
            T contract =
                    constructor.newInstance(null, storm3j, transactionManager, contractGasProvider);
            return create(contract, binary, encodedConstructor, value);
        } catch (TransactionException e) {
            throw e;
        } catch (Exception e) {
