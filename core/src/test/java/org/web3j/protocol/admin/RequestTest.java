...
public class RequestTest extends RequestTester {
    ...
    private Admin storm3j;

    @Override
    protected void initWeb3Client(HttpService httpService) {
        storm3j = Admin.build(httpService);
    }

    @Test
    public void testPersonalListAccounts() throws Exception {
        storm3j.personalListAccounts().send();
    ...
    public void testPersonalNewAccount() throws Exception {
        storm3j.personalNewAccount("password").send();
    ...
    public void testPersonalSendTransaction() throws Exception {
        storm3j.personalSendTransaction(
                        new Transaction(
                                "FROM",
                                BigInteger.ONE,
                                BigInteger.TEN,
    ...
    public void testPersonalUnlockAccountNoDuration() throws Exception {
        storm3j.personalUnlockAccount("0xfc390d8a8ddb591b010fda52f4db4945742c3809", "hunter2").send();
