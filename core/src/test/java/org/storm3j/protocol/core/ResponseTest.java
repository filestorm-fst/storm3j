...
public class ResponseTest extends ResponseTester {
    ...
    public void testErrorResponse() {
        ...
        FstBlock fstBlock = deserialiseResponse(FstBlock.class);
        assertTrue(fstBlock.hasError());
        assertThat(
                fstBlock.getError(),
                equalTo(
                        new Response.Error(
    ...
    public void testErrorResponseComplexData() {
        ...
        FstBlock fstBlock = deserialiseResponse(FstBlock.class);
        assertTrue(fstBlock.hasError());
        assertThat(fstBlock.getError().getData(), equalTo("{\"foo\":\"bar\"}"));
    }
    ...
    public void testEthProtocolVersion() throws IOException {
        ...
        FstProtocolVersion fstProtocolVersion = deserialiseResponse(FstProtocolVersion.class);
        assertThat(fstProtocolVersion.getProtocolVersion(), is("54"));
    }
    ...
    public void testEthSyncingInProgress() {
        ...
        FstSyncing fstSyncing = deserialiseResponse(FstSyncing.class);

        assertThat(
                fstSyncing.getResult(),
                equalTo(new FstSyncing.Syncing("0x384", "0x386", "0x454", null, null)));
    }
    ...
    public void testEthSyncing() {
        ...
        FstSyncing fstSyncing = deserialiseResponse(FstSyncing.class);
        assertThat(fstSyncing.isSyncing(), is(false));
    }
    ...
    public void testEthMining() {
        ...
        FstMining fstMining = deserialiseResponse(FstMining.class);
        assertThat(fstMining.isMining(), is(true));
    }
    ...
    public void testEthHashrate() {
        ...
        FstHashrate fstHashrate = deserialiseResponse(FstHashrate.class);
        assertThat(fstHashrate.getHashrate(), equalTo(BigInteger.valueOf(906L)));
    }
    ...
    public void testEthGasPrice() {
        ...
        FstGasPrice fstGasPrice = deserialiseResponse(FstGasPrice.class);
        assertThat(fstGasPrice.getGasPrice(), equalTo(BigInteger.valueOf(10000000000000L)));
    }
    ...
    public void testEthAccounts() {
        ...
        FstAccounts fstAccounts = deserialiseResponse(FstAccounts.class);
        assertThat(
                fstAccounts.getAccounts(),
    ...
    public void testEthBlockNumber() {
        ...
        FstBlockNumber fstBlockNumber = deserialiseResponse(FstBlockNumber.class);
        assertThat(fstBlockNumber.getBlockNumber(), equalTo(BigInteger.valueOf(1207L)));
    }
    ...
    public void testEthGetBalance() {
        ...
        FstGetBalance fstGetBalance = deserialiseResponse(FstGetBalance.class);
        assertThat(fstGetBalance.getBalance(), equalTo(BigInteger.valueOf(158972490234375000L)));
    }
    ...
    public void testEthStorageAt() {
        ...
        FstGetStorageAt fstGetStorageAt = deserialiseResponse(FstGetStorageAt.class);
        assertThat(
                fstGetStorageAt.getResult(),
    ...
    public void testEthGetTransactionCount() {
        ...
        FstGetTransactionCount fstGetTransactionCount =
                deserialiseResponse((FstGetTransactionCount.class));
        assertThat(fstGetTransactionCount.getTransactionCount(), equalTo(BigInteger.valueOf(1L)));
    }
    ...
    public void testEthGetBlockTransactionCountByHash() {
        ...
        FstGetBlockTransactionCountByHash fstGetBlockTransactionCountByHash =
                deserialiseResponse(FstGetBlockTransactionCountByHash.class);
        assertThat(
    ...
    public void testEthGetBlockTransactionCountByNumber() {
        ...
        FstGetBlockTransactionCountByNumber fstGetBlockTransactionCountByNumber =
                deserialiseResponse(FstGetBlockTransactionCountByNumber.class);
        assertThat(
    ...
    public void testEthGetUncleCountByBlockHash() {
        ...
        FstGetUncleCountByBlockHash fstGetUncleCountByBlockHash =
                deserialiseResponse(FstGetUncleCountByBlockHash.class);
        assertThat(fstGetUncleCountByBlockHash.getUncleCount(), equalTo(BigInteger.valueOf(1)));
    }
    ...
    public void testEthGetUncleCountByBlockNumber() {
        ...
        FstGetUncleCountByBlockNumber fstGetUncleCountByBlockNumber =
                deserialiseResponse(FstGetUncleCountByBlockNumber.class);
        assertThat(fstGetUncleCountByBlockNumber.getUncleCount(), equalTo(BigInteger.valueOf(1)));
    }
    ...
    public void testGetCode() {
        ...
        FstGetCode fstGetCode = deserialiseResponse(FstGetCode.class);
        assertThat(
                fstGetCode.getCode(),
                is(
    ...
    public void testEthSign() {
        ...
        FstSign fstSign = deserialiseResponse(FstSign.class);
        assertThat(
                fstSign.getSignature(),
                is(
    ...
    public void testEthSendTransaction() {
        ...
        FstSendTransaction fstSendTransaction = deserialiseResponse(FstSendTransaction.class);
        assertThat(
                fstSendTransaction.getTransactionHash(),
    ...
    public void testEthSendRawTransaction() {
        ...
        FstSendRawTransaction fstSendRawTransaction =
                deserialiseResponse(FstSendRawTransaction.class);
        assertThat(
                fstSendRawTransaction.getTransactionHash(),
                is("0xe670ec64341771606e55d6b4ca35a1a6b75ee3d5145a99d05921026d1527331"));
    }
    ...
    public void testEthCall() {
        ...
        FstCall fstCall = deserialiseResponse(FstCall.class);
        assertThat(fstCall.getValue(), is("0x"));
        assertFalse(fstCall.reverts());
        assertNull(fstCall.getRevertReason());
    }
    ...
    public void testEthCallReverted() {
        ...
        FstCall fstCall = deserialiseResponse(FstCall.class);
        assertTrue(fstCall.reverts());
        assertThat(
                fstCall.getRevertReason(),
                is(
    ...
    public void testEthEstimateGas() {
        ...
        FstEstimateGas fstEstimateGas = deserialiseResponse(FstEstimateGas.class);
        assertThat(fstEstimateGas.getAmountUsed(), equalTo(BigInteger.valueOf(21000)));
    }
        ...
        FstBlock.Block block =
                new FstBlock.Block(
                        ...
                        Arrays.asList(
                                "0x57919c4e72e79ad7705a26e7ecd5a08ff546ac4fa37882e9cc57be87a3dab26b",
                                "0x39a3eb432fbef1fc"));
        assertThat(fstBlock.getBlock(), equalTo(block));
    }
    ...
    public void testEthBlockFullTransactionsParity() {
        ...
        FstBlock.Block block =
                new FstBlock.Block(
                        ...
                        "0x54e34e8e",
                        Arrays.asList(
                                new FstBlock.TransactionObject(
    ...
    public void testEthTransaction() {
        ...
        FstTransaction fstTransaction = deserialiseResponse(FstTransaction.class);
        assertThat(fstTransaction.getTransaction().get(), equalTo(transaction));
    }
    ...
    public void testEthTransactionNull() {
        ...
        FstTransaction fstTransaction = deserialiseResponse(FstTransaction.class);
        assertThat(fstTransaction.getTransaction(), is(Optional.empty()));
    }
    ...
    public void testeEthGetTransactionReceiptBeforeByzantium() {
        ...
        FstGetTransactionReceipt fstGetTransactionReceipt =
                deserialiseResponse(FstGetTransactionReceipt.class);
        assertThat(
    ...
    public void testEthGetCompilers() {
        ...
        FstGetCompilers fstGetCompilers = deserialiseResponse(FstGetCompilers.class);
        assertThat(
                fstGetCompilers.getCompilers(),
    ...
    public void testEthCompileSolidity() {
        ...
        Map<String, FstCompileSolidity.Code> compiledSolidity = new HashMap<>(1);
        compiledSolidity.put(
                "test",
                new FstCompileSolidity.Code(
                        ...
                        new FstCompileSolidity.SolidityInfo(
                                "contract test {\n\tfunction multiply(uint a) returns(uint d) {\n"
                                        + "\t\treturn a * 7;\n\t}\n}\n",
                                "Solidity",
                                "0",
                                ...
                                Arrays.asList(
                                        new AbiDefinition(
                                                ...
                                                "function",
                                                false)),
                                new FstCompileSolidity.Documentation(),
                                new FstCompileSolidity.Documentation())));

        FstCompileSolidity fstCompileSolidity = deserialiseResponse(FstCompileSolidity.class);
        assertThat(fstCompileSolidity.getCompiledSolidity(), equalTo(compiledSolidity));
    }
    ...
    public void testEthCompileLLL() {
        ...
        FstCompileLLL fstCompileLLL = deserialiseResponse(FstCompileLLL.class);
        assertThat(
                fstCompileLLL.getCompiledSourceCode(),
                is(
    ...
    public void testEthCompileSerpent() {
        ...
        FstCompileSerpent fstCompileSerpent = deserialiseResponse(FstCompileSerpent.class);
        assertThat(
                fstCompileSerpent.getCompiledSourceCode(),
                is(
                        "0x603880600c6000396000f3006001600060e060020a600035048063c6888fa114601857005b60"
                                + "21600435602b565b8060005260206000f35b600081600702905091905056"));
    }
    ...
    public void testEthFilter() {
        ...
        FstFilter fstFilter = deserialiseResponse(FstFilter.class);
        assertThat(fstFilter.getFilterId(), is(BigInteger.valueOf(1)));
    }
    ...
    public void testEthUninstallFilter() {
        ...
        FstUninstallFilter fstUninstallFilter = deserialiseResponse(FstUninstallFilter.class);
        assertThat(fstUninstallFilter.isUninstalled(), is(true));
    }
    ...
    public void testEthLog() {
        ...
        FstLog fstLog = deserialiseResponse(FstLog.class);
        assertThat(fstLog.getLogs(), is(logs));
    }
    ...
    public void testEthGetWork() {
        ...
        FstGetWork fstGetWork = deserialiseResponse(FstGetWork.class);
        assertThat(
                fstGetWork.getCurrentBlockHeaderPowHash(),
                is("0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef"));
        assertThat(
                fstGetWork.getSeedHashForDag(),
                is("0x5EED00000000000000000000000000005EED0000000000000000000000000000"));
        assertThat(
                fstGetWork.getBoundaryCondition(),
    ...
    public void testEthSubmitWork() {
        ...
        FstSubmitWork fstSubmitWork = deserialiseResponse(FstSubmitWork.class);
        assertThat(fstSubmitWork.solutionValid(), is(true));
    }
    ...
    public void testEthSubmitHashrate() {
        ...
        FstSubmitHashrate fstSubmitHashrate = deserialiseResponse(FstSubmitHashrate.class);
        assertThat(fstSubmitHashrate.submissionSuccessful(), is(true));
    }
