 ...
 */
package org.storm3j.protocol.http;
...
import org.storm3j.protocol.core.methods.response.FstBlockNumber;
import org.storm3j.protocol.core.methods.response.FstSubscribe;
import org.storm3j.protocol.exceptions.ClientConnectionException;
...
public class HttpServiceTest {
    ...
    public void httpWebException() throws IOException {
        ...
        Request<String, FstBlockNumber> request =
                new Request<>(
                        "eth_blockNumber1",
        ...
        try {
            mockedHttpService.send(request, FstBlockNumber.class);
    ...
    public void subscriptionNotSupported() {
        Request<Object, FstSubscribe> subscribeRequest =
                new Request<>(
                        "eth_subscribe",
