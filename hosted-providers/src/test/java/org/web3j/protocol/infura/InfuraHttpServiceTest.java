 ...
 */
package org.storm3j.protocol.infura;
...
import static org.storm3j.protocol.infura.InfuraHttpService.buildClientVersionHeader;
        ...
        assertThat(
                ...
                equalTo(
                        Collections.singletonMap(
                                "Infura-Fst-Preferred-Client", "geth 1.4.19")));

        assertThat(
                buildClientVersionHeader("geth 1.4.19", false),
                is(
                        Collections.singletonMap(
                                "Infura-Fst-Preferred-Client",
