...
public class Address implements Type<String> {
    ...
    private final org.storm3j.abi.datatypes.Uint value;

    public Address(org.storm3j.abi.datatypes.Uint value) {
        this.value = value;
    }
    ...
    public Address(int bitSize, BigInteger value) {
        this(new org.storm3j.abi.datatypes.Uint(bitSize, value));
    }
    ...
    public org.storm3j.abi.datatypes.Uint toUint() {
        return value;
    }
