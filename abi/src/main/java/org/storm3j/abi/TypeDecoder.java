...
import org.storm3j.abi.datatypes.Array;
import org.storm3j.abi.datatypes.Bool;
import org.storm3j.abi.datatypes.Bytes;
import org.storm3j.abi.datatypes.BytesType;
...
import org.storm3j.abi.datatypes.FixedPointType;
import org.storm3j.abi.datatypes.Int;
import org.storm3j.abi.datatypes.IntType;
import org.storm3j.abi.datatypes.NumericType;
...
import static org.storm3j.abi.TypeReference.makeTypeReference;
    ...
    static Type instantiateArrayType(TypeReference ref, Object value)
        ...
        if (value instanceof List) {
            ...
            throw new ClassCastException(
                    "Arg of type "
                            + value.getClass()
                            + " should be a list to instantiate storm3j Array");
        }
        ...
        if (arraySize <= 0) {
            ...
            Class arrayClass =
                    Class.forName("org.storm3j.abi.datatypes.generated.StaticArray" + arraySize);
        ...
        try {
            Class<? extends StaticArray> arrayClass =
                    (Class<? extends StaticArray>)
                            Class.forName("org.storm3j.abi.datatypes.generated.StaticArray" + length);
