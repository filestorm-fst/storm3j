...
public interface Eea extends Storm3j {
    static Eea build(Storm3jService storm3jService) {
        return new JsonRpc2_0Eea(storm3jService);
    }

    Request<?, FstSendTransaction> eeaSendRawTransaction(final String signedTransactionData);
}
