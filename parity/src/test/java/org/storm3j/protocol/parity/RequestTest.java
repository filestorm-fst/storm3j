 ...
 */
package org.storm3j.protocol.parity;
...
import org.storm3j.crypto.WalletFile;
...
import org.storm3j.protocol.parity.methods.request.Derivation;
import org.storm3j.protocol.parity.methods.request.TraceFilter;
import org.storm3j.utils.Numeric;

public class RequestTest extends RequestTester {

    private Parity storm3j;

    @Override
    protected void initWeb3Client(HttpService httpService) {
        storm3j = Parity.build(httpService);
    }

    @Test
    public void testParityAllAccountsInfo() throws Exception {
        storm3j.parityAllAccountsInfo().send();
    ...
    public void testParityDeriveAddressHash() throws Exception {
        ...
        storm3j.parityDeriveAddressHash(
    ...
    public void testParityDeriveAddressIndex() throws Exception {
        ...
        storm3j.parityDeriveAddressIndex(
    ...
    public void testParityExportAccount() throws Exception {
        storm3j.parityExportAccount("0x407d73d8a49eeb85d32cf465507dd71d507100c1", "hunter2").send();
    ...
    public void testParityGetDappAddresses() throws Exception {
        storm3j.parityGetDappAddresses("web").send();
    ...
    public void testParityGetDefaultDappAddress() throws Exception {
        storm3j.parityGetDappDefaultAddress("web").send();
    ...
    public void testParityGetNewDappsDefaultAddress() throws Exception {
        storm3j.parityGetNewDappsDefaultAddress().send();
    ...
    public void testParityImportGethAccounts() throws Exception {
        ...
        storm3j.parityImportGethAccounts(gethAccounts).send();
    ...
    public void testParityKillAccount() throws Exception {
        storm3j.parityKillAccount("0x407d73d8a49eeb85d32cf465507dd71d507100c1", "hunter2").send();
    ...
    public void testParityListAccountsNoAccountOffsetNoBlockTag() throws Exception {
        ...
        storm3j.parityListAccounts(maxQuantityReturned, null, null).send();
    ...
    public void testParityListAccountsNoAccountOffsetWithBlockTag() throws Exception {
        ...
        storm3j.parityListAccounts(maxQuantityReturned, null, blockParameter).send();
    ...
    public void testParityListGethAccounts() throws Exception {
        storm3j.parityListGethAccounts().send();
    ...
    public void testParityListRecentDapps() throws Exception {
        storm3j.parityListRecentDapps().send();
    ...
    public void testParityNewAccountFromPhrase() throws Exception {
        storm3j.parityNewAccountFromPhrase("phrase", "password").send();
    ...
    public void testParityNewAccountFromSecret() throws Exception {
        ...
        storm3j.parityNewAccountFromSecret(
    ...
    public void testParityNewAccountFromWallet() throws Exception {
        ...
        storm3j.parityNewAccountFromWallet(walletFile, "password").send();
    ...
    public void testParityRemoveAddress() throws Exception {
        storm3j.parityRemoveAddress("0x407d73d8a49eeb85d32cf465507dd71d507100c1").send();
    ...
    public void testParitySetAccountMeta() throws Exception {
        ...
        meta.put("foo", "bar");
        storm3j.paritySetAccountMeta("0xfc390d8a8ddb591b010fda52f4db4945742c3809", meta).send();
    ...
    public void testParitySetAccountName() throws Exception {
        storm3j.paritySetAccountName("0xfc390d8a8ddb591b010fda52f4db4945742c3809", "Savings").send();
    ...
    public void testParitySetDappAddresses() throws Exception {
        ...
        storm3j.paritySetDappAddresses("web", dAppAddresses).send();
    ...
    public void testParitySetDappDefaultAddress() throws Exception {
        storm3j.paritySetDappDefaultAddress("web", "0x407d73d8a49eeb85d32cf465507dd71d507100c1")
                .send();
    ...
    public void testParitySetNewDappsAddresses() throws Exception {
        ArrayList<String> dAppAddresses = new ArrayList<>();
        dAppAddresses.add("0x407d73d8a49eeb85d32cf465507dd71d507100c1");
        storm3j.paritySetNewDappsAddresses(dAppAddresses).send();
    ...
    public void testParitySetNewDappsDefaultAddress() throws Exception {
        storm3j.paritySetNewDappsDefaultAddress("0x407d73d8a49eeb85d32cf465507dd71d507100c1").send();
    ...
    public void testParityTestPassword() throws Exception {
        storm3j.parityTestPassword("0x407d73d8a49eeb85d32cf465507dd71d507100c1", "hunter2").send();
    ...
    public void testTraceReplayTransaction() throws Exception {
        storm3j.traceReplayTransaction(
    ...
    public void testTraceBlock() throws Exception {
        storm3j.traceBlock(DefaultBlockParameterName.LATEST).send();
