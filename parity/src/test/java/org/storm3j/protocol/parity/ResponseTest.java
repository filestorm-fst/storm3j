...
import org.storm3j.protocol.core.methods.response.VoidResponse;
import org.storm3j.protocol.parity.methods.response.FullTraceInfo;
import org.storm3j.protocol.parity.methods.response.ParityAddressesResponse;
import org.storm3j.protocol.parity.methods.response.ParityAllAccountsInfo;
import org.storm3j.protocol.parity.methods.response.ParityDefaultAddressResponse;
import org.storm3j.protocol.parity.methods.response.ParityDeriveAddress;
import org.storm3j.protocol.parity.methods.response.ParityExportAccount;
import org.storm3j.protocol.parity.methods.response.ParityFullTraceResponse;
import org.storm3j.protocol.parity.methods.response.ParityListRecentDapps;
import org.storm3j.protocol.parity.methods.response.StateDiff;
import org.storm3j.protocol.parity.methods.response.Trace;
import org.storm3j.protocol.parity.methods.response.VMTrace;
...
public class ResponseTest extends ResponseTester {
    ...
    public void testParityFullTraceResponseTraces() {
        ...
        org.storm3j.protocol.parity.methods.response.Trace trace1 =
                new org.storm3j.protocol.parity.methods.response.Trace();
        ...
        org.storm3j.protocol.parity.methods.response.Trace trace2 =
                new org.storm3j.protocol.parity.methods.response.Trace();
        ...
        org.storm3j.protocol.parity.methods.response.Trace trace3 =
                new org.storm3j.protocol.parity.methods.response.Trace();
        ...
        org.storm3j.protocol.parity.methods.response.Trace trace4 =
                new org.storm3j.protocol.parity.methods.response.Trace();
        ...
        List<org.storm3j.protocol.parity.methods.response.Trace> traces = new ArrayList<>();
        traces.add(trace1);
        traces.add(trace2);
        traces.add(trace3);
        traces.add(trace4);
