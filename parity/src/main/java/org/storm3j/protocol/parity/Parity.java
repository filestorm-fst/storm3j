...
public interface Parity extends Admin, Trace {
     ...
     */
    static Parity build(Storm3jService storm3jService) {
        return new JsonRpc2_0Parity(storm3jService);
    }
    ...
    static Parity build(
        ...
        return new JsonRpc2_0Parity(storm3jService, pollingInterval, scheduledExecutorService);
    }
