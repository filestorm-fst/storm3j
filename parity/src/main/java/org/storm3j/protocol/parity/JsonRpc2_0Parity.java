...
import org.storm3j.protocol.parity.methods.response.ParityTraceGet;
import org.storm3j.protocol.parity.methods.response.ParityTracesResponse;
...
public class JsonRpc2_0Parity extends JsonRpc2_0Admin implements Parity {
    ...
    public JsonRpc2_0Parity(Storm3jService storm3jService) {
    ...
    public Request<?, ParityTracesResponse> traceTransaction(String hash) {
        return new Request<>(
                "trace_transaction", Arrays.asList(hash), storm3jService, ParityTracesResponse.class);
    }
}
